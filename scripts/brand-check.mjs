 ...
 * favicon, PWA icons and title for a plain utility that keeps the og.app.me
...
export const OG_PENDING_REL_PATH = ".app/og-pending";
  ...
  if (cardPath !== undefined) {
    ...
    warnings.push(
      `BRAND WARNING: ${workspaceRoot}/public/og.jpg is missing and this pass exists to `
        ...
        + "report that instead of reporting a pass — the app keeps the og.app.me "
        + "placeholder.",
    );
  } else {
    warnings.push(
