...
export const GATE_PROVIDER_ID = "app-gate";
const GATE_ACCOUNT_ISSUER = "https://app.com";
...
/**
 * Clear a stale marker when a `/get-session` arrives without `x-app-identity`:
