  ...
  return (
    <div className="space-y-4">
      ...
      <Modal
        ...
        title={mode.salesType === "SERVICE" ? "فاتورة خدمة تطريز" : mode.kind === "sale" ? "فاتورة مبيعات" : "فاتورة مشتريات"}
        size="xl"
      >
        <div className="space-y-4">
          <FormSection title="بيانات الفاتورة" icon={Receipt} tone="brand">
            <FormGrid cols={3}>
              ...
              <div>
                <FieldLabel required>{mode.kind === "sale" ? "العميل" : "المورد"}</FieldLabel>
                <AppSelect
                  value={partyId}
                  onChange={setPartyId}
          ...
          <FormSection
            ...
            description={
              mode.salesType === "SERVICE"
                ...
                : "اكتب البيان والكمية والسعر ثم اضغط Enter — البند يُضاف فورًا"
            }
            icon={Layers}
            tone="warn"
            action={
      ...
      <DocumentActionsSheet
        ...
        documentId={actionsId}
        documentType="invoice"
        onClose={() => setActionsId(null)}
        onDeleted={() => {
          if (actionsId) deleteInvoice(actionsId);
          setActionsId(null);
        }}
      />
    </div>
