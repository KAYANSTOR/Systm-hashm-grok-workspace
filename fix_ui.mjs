...
if (!content.includes('صرف مخزني')) {
    content = content.replace(
      '<button type="button" className="btn-ghost text-good" onClick={() => {',
      issueButton + '          <button type="button" className="btn-ghost text-good" onClick={() => {'
    );
}
